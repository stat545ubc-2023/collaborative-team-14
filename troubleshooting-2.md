...
```
    ...
    ##    <chr>                                        <dbl>      <dbl>
    ##  1 Dangerous Minds                                1.5          5
    ##  2 Dumbo                                          1.5          5
    ##  3 Sleepers                                       2            5
    ##  4 Escape from New York                           1            5
    ##  5 Cinema Paradiso (Nuovo cinema Paradiso)        2            5
    ##  6 Deer Hunter, The                               0.5          5
    ##  7 Ben-Hur                                        0.5          5
    ##  8 Gandhi                                         1.5          5
    ##  9 Dracula (Bram Stoker's Dracula)                1            5
    ## 10 Cape Fear                                      2            5
    ## # ℹ 8,822 more rows
...
```
    ...
    ## ℹ In group 14: `species = "Toydarian"`.
    ...
    ##  4 Rodian            173    74
    ##  5 Hutt              175  1358
    ##  6 Yoda's species     66    17
    ##  7 Trandoshan        190   113
    ##  8 Mon Calamari      180    83
    ##  9 Ewok               88    20
    ## 10 Sullustan         160    68
    ## # ℹ 28 more rows
...
```
    ...
    ##   name               birth_weight birth_year birth_location    
    ##   <chr>                     <dbl>      <dbl> <chr>             
    ## 1 Luke Skywalker             1998       1.35 Liverpool, England
    ## 2 C-3PO                      1999       1.8  Liverpool, England
    ## 3 R2-D2                      2000       2.25 Seattle, WA       
    ## 4 Darth Vader                2001       2.7  Liverpool, England
    ## 5 Leia Organa                2002       3.15 New York, NY      
    ## 6 Owen Lars                  2003       3.6  Seattle, WA       
    ## 7 Beru Whitesun Iars         2004       4.05 Liverpool, England
    ## 8 R5-D4                      2005       4.5  New York, NY
